...
import RejectDepositTable from "../Table/RejectedDepositTable";
import { useClickOutside } from "../../../../hooks/useClickOutside";
import { useGetAllRejectRechargeQuery } from "../../../../services/AdminRecharge";

const RejectedTransaction = () => {
  let isLoadingCancelDepositHistory;
  ...
  const { data } = useGetAllRejectRechargeQuery();
  console.log({ data });
  ...
  return (
    <>
      <SectionCommonTable
        ...
        sectionTableTitle={`Reject Recharge History (${
          filterData?.length > 0
            ? filterData?.length
        ...
        <div className="ss-trade_commol_modal_field">
          <div className="transaction_details">
            ...
            <div className="group">
              ...
              <p>
                <strong>Time:</strong>{" "}
                <span>{details?.time?.time || details?.time}&nbsp;(IST)</span>
              </p>
            </div>
            <div className="group">
              <p>
